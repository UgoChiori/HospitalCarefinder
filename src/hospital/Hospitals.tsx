...
const Hospitals: React.FC<HospitalProps> = () => {
  ...
  //       setLoading(true);
  //       try {
  //         const res = await axios.get("https://hospital-carefinder-477hu547y-ugochiori.vercel.app/api/maps/place?latitude=6.468137&longitude=3.638487&radius=30000");
